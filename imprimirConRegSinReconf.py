def IMP(Results_Folder, individuos, pareto, RESPUESTA, PosicionesReg, RESPUESTApoblacion, RESP_inflexion, BarrasConPVs, Semilla, NombreArchivo, TipoDsimulacion, iteraciones):
    import numpy as np
    import pandas as pd
    ...
    PoblOrdenada=np.zeros((individuos, PosicionesReg))
    cont=0
