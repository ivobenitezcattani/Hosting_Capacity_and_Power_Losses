def IMP(Results_Folder, individuos, pareto, RESPUESTA, NameCaps, RESPUESTApoblacion, RESP_inflexion, BarrasConPVs, Semilla, NombreArchivo, TipoDsimulacion, iteraciones):
    import numpy as np
    import pandas as pd
    ...
    PoblOrdenada=np.zeros((individuos, len(NameCaps)))
    cont=0
    ...
    NombreAux = Results_Folder + "\\Capacitor\\"
