def IMP(Results_Folder, individuos, pareto, RESPUESTA, CtdPV, RESPUESTApoblacion, RESP_inflexion, BarrasConPVs, Semilla, NombreArchivo, TipoDsimulacion, iteraciones):
    import numpy as np
    import pandas as pd
    ...
    PoblOrdenada=np.zeros((individuos, 4 * 2))
    ...
    NombreAux = Results_Folder + "\\Volt_VAR\\"
