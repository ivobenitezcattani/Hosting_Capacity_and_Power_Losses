def IMP(Results_Folder, individuos, pareto, RESPUESTA, NLL, PosicionesReg, CapN, CtdPV, RESPUESTApoblacion, RESP_inflexion, BarrasConPVs, Semilla, NombreArchivo, TipoDsimulacion, iteraciones):
    import numpy as np
    import pandas as pd
    ...
    PoblOrdenada=np.zeros((individuos, NLL + PosicionesReg + CapN + 4 * 2))
    ...
    NombreAux = Results_Folder + "\\Combination\\"
